...
function shell(title, intro, b) {
  ...
  <div style="max-width:520px;margin:0 auto;padding:24px;">
    <div style="background:#c01524;border-radius:16px 16px 0 0;padding:22px 24px;color:#fff;">
      <div style="font-size:18px;font-weight:700;">🚗 BS Trafikkskole</div>
      <div style="font-size:12px;opacity:.85;">Kjøreskole · Folkenborgveien 2, 1850 Mysen</div>
    </div>
    <div style="background:#fff;border:1px solid #ebe7ea;border-top:none;border-radius:0 0 16px 16px;padding:24px;">
      <h1 style="margin:0 0 8px;font-size:20px;color:#1d151a;">${esc(title)}</h1>
      <p style="margin:0 0 18px;color:#6f6a73;font-size:14px;line-height:1.5;">${intro}</p>
